...
$pageTitle = "Delete Project - " . $project->getName();
ob_start();
?>

<div class="container p-4 my-3 rounded-3 border shadow-md">
    <h1 class="display-4 fw-bold lh-1">Delete Project</h1>
</div>

<div class="container my-3 p-0 rounded-3 border shadow-md">
    <form class="row g-3 p-3" action="/ProjectManager/projects/<?= $project->getId() ?>/delete" method="POST">
